...
# HubLive install script for Linux
...
get_latest_version()
{
  latest_version=$(curl -s https://api.github.com/repos/hublive/$REPO/releases/latest | grep -oP '"tarball_url": ".*/tarball/v\K([^/]*)(?=")')
...
ARCHIVE_URL="https://github.com/hublive/$REPO/releases/download/v${VERSION}/${REPO}_${VERSION}_linux_${ARCH}.tar.gz"
...
log "\nhublive-server is installed to $INSTALL_PATH\n"
