...
import (
	...
	"__GITHUB_HUBLIVE__protocol/tracer/jaeger"
...
var baseFlags = []cli.Flag{
	...
	&cli.StringFlag{
		Name:  "config",
		Usage: "path to HubLive config file",
	},
	&cli.StringFlag{
		Name:    "config-body",
		Usage:   "HubLive config in YAML, typically passed in as an environment var in a container",
		Sources: cli.EnvVars("HUBLIVE_CONFIG"),
	},
	&cli.StringFlag{
		Name:  "key-file",
	...
	&cli.StringFlag{
		...
		Sources: cli.EnvVars("HUBLIVE_KEYS"),
	},
	&cli.StringFlag{
		Name:    "region",
		Usage:   "region of the current node. Used by regionaware node selector",
		Sources: cli.EnvVars("HUBLIVE_REGION"),
	},
	&cli.StringFlag{
		Name:    "node-ip",
	...
	&cli.StringFlag{
		...
		Sources: cli.EnvVars("HUBLIVE_TURN_CERT"),
	},
	&cli.StringFlag{
		Name:    "turn-key",
		Usage:   "tls key file for TURN server",
		Sources: cli.EnvVars("HUBLIVE_TURN_KEY"),
	},
	&cli.StringFlag{
		Name:  "cpuprofile",
...
func startServer(ctx context.Context, c *cli.Command) error {
	...
	if url := conf.Trace.JaegerURL; url != "" {
		jaeger.Configure(ctx, url, "hublive")
	}
