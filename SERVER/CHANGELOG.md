...
### Fixed
- Fix concurrent map access for https://github.com/hublive/hublive/issues/4126. (#4127)
...
- fix(deps): update module github.com/HubLive/protocol to v1.39.3 (#3733)
...
- Update module github.com/HubLive/protocol to v1.40.0 (#3865)
...
forwarding media unchanged to the HubLive subscribers. This behavior can
...
Support for HubLive SIP Bridge
...
- Fix panic occurs when starting hublive-server with key-file option (#2312) (#2313)
...
- Split out shared media transport code into HubLive/mediatransportutil #1071
...
- Fully removed references to VP9. HubLive is focused on AV1. #1004
...
- Allow hublive-server to start without keys configuration (#788)
