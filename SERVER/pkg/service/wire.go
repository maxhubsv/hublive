...
func InitializeServer(conf *config.Config, currentNode routing.LocalNode) (*HubliveServer, error) {
	wire.Build(
		getNodeID,
		createRedisClient,
		createStore,
		...
		wire.Bind(new(hublive.RoomService), new(*RoomService)),
...
func getNodeID(currentNode routing.LocalNode) hublive.NodeID {
...
func createRedisClient(conf *config.Config) (redis.UniversalClient, error) {
	...
	return redisHubLive.GetRedisClient(&conf.Redis)
}
