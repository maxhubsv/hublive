...
func RecordRequest(ctx context.Context, request proto.Message) {
	...
	a, ok := ctx.Value(twirpTelemetryKey{}).(*hublive.APICallInfo)
	if !ok || a == nil {
		return
	}
	...
	case *hublive.CreateRoomRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_CreateRoomRequest{
				CreateRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetName()

	case *hublive.ListRoomsRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_ListRoomsRequest{
				ListRoomsRequest: msg,
			},
		}

	case *hublive.DeleteRoomRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_DeleteRoomRequest{
				DeleteRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *hublive.ListParticipantsRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_ListParticipantsRequest{
				ListParticipantsRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *hublive.RoomParticipantIdentity:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_RoomParticipantIdentity{
	...
	case *hublive.MuteRoomTrackRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_MuteRoomTrackRequest{
	...
	case *hublive.UpdateParticipantRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_UpdateParticipantRequest{
	...
	case *hublive.UpdateSubscriptionsRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_UpdateSubscriptionsRequest{
	...
	case *hublive.SendDataRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_SendDataRequest{
				SendDataRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *hublive.UpdateRoomMetadataRequest:
		a.Request = &hublive.APICallRequest{
			Message: &hublive.APICallRequest_UpdateRoomMetadataRequest{
