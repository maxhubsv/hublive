...
import (
	...
	redis2 "__GITHUB_HUBLIVE__protocol/redis"
...
func InitializeServer(conf *config.Config, currentNode routing.LocalNode) (*HubliveServer, error) {
	...
	hubliveServer, err := NewHubliveServer(conf, roomService, agentDispatchService, egressService, ingressService, sipService, ioInfoService, rtcService, serviceWHIPService, agentService, keyProvider, router, roomManager, signalServer, server, currentNode)
	if err != nil {
		return nil, err
	}
