...
func (s *EgressService) StartRoomCompositeEgress(ctx context.Context, req *hublive.RoomCompositeEgressRequest) (*hublive.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartWebEgress(ctx context.Context, req *hublive.WebEgressRequest) (*hublive.EgressInfo, error) {
	fields := []any{
		"url", req.Url,
		"outputType", egress.GetOutputType(req),
	}
...
func (s *EgressService) StartParticipantEgress(ctx context.Context, req *hublive.ParticipantEgressRequest) (*hublive.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackCompositeEgress(ctx context.Context, req *hublive.TrackCompositeEgressRequest) (*hublive.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackEgress(ctx context.Context, req *hublive.TrackEgressRequest) (*hublive.EgressInfo, error) {
...
func (s *EgressService) startEgress(ctx context.Context, req *rpc.StartEgressRequest) (*hublive.EgressInfo, error) {
...
func (s *egressLauncher) StartEgress(ctx context.Context, req *rpc.StartEgressRequest) (*hublive.EgressInfo, error) {
	if s.client == nil {
		return nil, ErrEgressNotConnected
	}
	...
	if req.RoomId == "" {
		...
		if roomName != "" {
			room, _, err := s.store.LoadRoom(ctx, hublive.RoomName(roomName), false)
			if err != nil {
				return nil, err
			}
			req.RoomId = room.Sid
...
func (s *egressLauncher) StopEgress(ctx context.Context, req *hublive.StopEgressRequest) (*hublive.EgressInfo, error) {
	if s.client == nil {
		return nil, ErrEgressNotConnected
	}
...
func (s *EgressService) UpdateLayout(ctx context.Context, req *hublive.UpdateLayoutRequest) (*hublive.EgressInfo, error) {
	...
	_, err = s.roomService.UpdateParticipant(ctx, &hublive.UpdateParticipantRequest{
		Room:     info.RoomName,
...
func (s *EgressService) UpdateStream(ctx context.Context, req *hublive.UpdateStreamRequest) (*hublive.EgressInfo, error) {
	...
	if err != nil {
		...
		switch info.Status {
		case hublive.EgressStatus_EGRESS_STARTING,
			hublive.EgressStatus_EGRESS_ACTIVE:
			return nil, err
		default:
...
func (s *EgressService) ListEgress(ctx context.Context, req *hublive.ListEgressRequest) (*hublive.ListEgressResponse, error) {
	if req.RoomName != "" {
...
func (s *EgressService) StopEgress(ctx context.Context, req *hublive.StopEgressRequest) (info *hublive.EgressInfo, err error) {
	defer func() {
