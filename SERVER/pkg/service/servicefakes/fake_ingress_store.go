...
type FakeIngressStore struct {
	DeleteIngressStub        func(context.Context, *hublive.IngressInfo) error
	...
	ListIngressStub        func(context.Context, hublive.RoomName) ([]*hublive.IngressInfo, error)
	...
	LoadIngressStub        func(context.Context, string) (*hublive.IngressInfo, error)
	...
	LoadIngressFromStreamKeyStub        func(context.Context, string) (*hublive.IngressInfo, error)
	...
	StoreIngressStub        func(context.Context, *hublive.IngressInfo) error
	...
	UpdateIngressStub        func(context.Context, *hublive.IngressInfo) error
	...
	UpdateIngressStateStub        func(context.Context, string, *hublive.IngressState) error
	updateIngressStateMutex       sync.RWMutex
	updateIngressStateArgsForCall []struct {
		arg1 context.Context
		arg2 string
		arg3 *hublive.IngressState
	}
...
func (fake *FakeIngressStore) DeleteIngress(arg1 context.Context, arg2 *hublive.IngressInfo) error {
...
func (fake *FakeIngressStore) DeleteIngressCalls(stub func(context.Context, *hublive.IngressInfo) error) {
	fake.deleteIngressMutex.Lock()
	defer fake.deleteIngressMutex.Unlock()
	fake.DeleteIngressStub = stub
}

func (fake *FakeIngressStore) DeleteIngressArgsForCall(i int) (context.Context, *hublive.IngressInfo) {
	fake.deleteIngressMutex.RLock()
	defer fake.deleteIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) ListIngress(arg1 context.Context, arg2 hublive.RoomName) ([]*hublive.IngressInfo, error) {
...
func (fake *FakeIngressStore) ListIngressCalls(stub func(context.Context, hublive.RoomName) ([]*hublive.IngressInfo, error)) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
	fake.ListIngressStub = stub
}

func (fake *FakeIngressStore) ListIngressArgsForCall(i int) (context.Context, hublive.RoomName) {
	fake.listIngressMutex.RLock()
	defer fake.listIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) ListIngressReturns(result1 []*hublive.IngressInfo, result2 error) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
...
func (fake *FakeIngressStore) ListIngressReturnsOnCall(i int, result1 []*hublive.IngressInfo, result2 error) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
	fake.ListIngressStub = nil
...
func (fake *FakeIngressStore) LoadIngress(arg1 context.Context, arg2 string) (*hublive.IngressInfo, error) {
...
func (fake *FakeIngressStore) LoadIngressCalls(stub func(context.Context, string) (*hublive.IngressInfo, error)) {
	fake.loadIngressMutex.Lock()
...
func (fake *FakeIngressStore) LoadIngressReturns(result1 *hublive.IngressInfo, result2 error) {
	fake.loadIngressMutex.Lock()
	defer fake.loadIngressMutex.Unlock()
...
func (fake *FakeIngressStore) LoadIngressReturnsOnCall(i int, result1 *hublive.IngressInfo, result2 error) {
	fake.loadIngressMutex.Lock()
	defer fake.loadIngressMutex.Unlock()
	fake.LoadIngressStub = nil
...
func (fake *FakeIngressStore) LoadIngressFromStreamKey(arg1 context.Context, arg2 string) (*hublive.IngressInfo, error) {
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyCalls(stub func(context.Context, string) (*hublive.IngressInfo, error)) {
	fake.loadIngressFromStreamKeyMutex.Lock()
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyReturns(result1 *hublive.IngressInfo, result2 error) {
	fake.loadIngressFromStreamKeyMutex.Lock()
	defer fake.loadIngressFromStreamKeyMutex.Unlock()
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyReturnsOnCall(i int, result1 *hublive.IngressInfo, result2 error) {
	fake.loadIngressFromStreamKeyMutex.Lock()
	defer fake.loadIngressFromStreamKeyMutex.Unlock()
	fake.LoadIngressFromStreamKeyStub = nil
...
func (fake *FakeIngressStore) StoreIngress(arg1 context.Context, arg2 *hublive.IngressInfo) error {
...
func (fake *FakeIngressStore) StoreIngressCalls(stub func(context.Context, *hublive.IngressInfo) error) {
	fake.storeIngressMutex.Lock()
	defer fake.storeIngressMutex.Unlock()
	fake.StoreIngressStub = stub
}

func (fake *FakeIngressStore) StoreIngressArgsForCall(i int) (context.Context, *hublive.IngressInfo) {
	fake.storeIngressMutex.RLock()
	defer fake.storeIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) UpdateIngress(arg1 context.Context, arg2 *hublive.IngressInfo) error {
...
func (fake *FakeIngressStore) UpdateIngressCalls(stub func(context.Context, *hublive.IngressInfo) error) {
	fake.updateIngressMutex.Lock()
	defer fake.updateIngressMutex.Unlock()
	fake.UpdateIngressStub = stub
}

func (fake *FakeIngressStore) UpdateIngressArgsForCall(i int) (context.Context, *hublive.IngressInfo) {
	fake.updateIngressMutex.RLock()
	defer fake.updateIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) UpdateIngressState(arg1 context.Context, arg2 string, arg3 *hublive.IngressState) error {
...
func (fake *FakeIngressStore) UpdateIngressStateCalls(stub func(context.Context, string, *hublive.IngressState) error) {
	fake.updateIngressStateMutex.Lock()
	defer fake.updateIngressStateMutex.Unlock()
	fake.UpdateIngressStateStub = stub
}

func (fake *FakeIngressStore) UpdateIngressStateArgsForCall(i int) (context.Context, string, *hublive.IngressState) {
	fake.updateIngressStateMutex.RLock()
	defer fake.updateIngressStateMutex.RUnlock()
