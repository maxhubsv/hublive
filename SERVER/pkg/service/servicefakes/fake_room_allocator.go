...
type FakeRoomAllocator struct {
	...
	CreateRoomStub        func(context.Context, *hublive.CreateRoomRequest, bool) (*hublive.Room, *hublive.RoomInternal, bool, error)
	...
	SelectRoomNodeStub        func(context.Context, hublive.RoomName, hublive.NodeID) error
	...
	ValidateCreateRoomStub        func(context.Context, hublive.RoomName) error
...
func (fake *FakeRoomAllocator) CreateRoom(arg1 context.Context, arg2 *hublive.CreateRoomRequest, arg3 bool) (*hublive.Room, *hublive.RoomInternal, bool, error) {
...
func (fake *FakeRoomAllocator) CreateRoomCalls(stub func(context.Context, *hublive.CreateRoomRequest, bool) (*hublive.Room, *hublive.RoomInternal, bool, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRoomAllocator) CreateRoomArgsForCall(i int) (context.Context, *hublive.CreateRoomRequest, bool) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRoomAllocator) CreateRoomReturns(result1 *hublive.Room, result2 *hublive.RoomInternal, result3 bool, result4 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRoomAllocator) CreateRoomReturnsOnCall(i int, result1 *hublive.Room, result2 *hublive.RoomInternal, result3 bool, result4 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
...
func (fake *FakeRoomAllocator) SelectRoomNode(arg1 context.Context, arg2 hublive.RoomName, arg3 hublive.NodeID) error {
...
func (fake *FakeRoomAllocator) SelectRoomNodeCalls(stub func(context.Context, hublive.RoomName, hublive.NodeID) error) {
	fake.selectRoomNodeMutex.Lock()
	defer fake.selectRoomNodeMutex.Unlock()
	fake.SelectRoomNodeStub = stub
}

func (fake *FakeRoomAllocator) SelectRoomNodeArgsForCall(i int) (context.Context, hublive.RoomName, hublive.NodeID) {
	fake.selectRoomNodeMutex.RLock()
	defer fake.selectRoomNodeMutex.RUnlock()
...
func (fake *FakeRoomAllocator) ValidateCreateRoom(arg1 context.Context, arg2 hublive.RoomName) error {
...
func (fake *FakeRoomAllocator) ValidateCreateRoomCalls(stub func(context.Context, hublive.RoomName) error) {
	fake.validateCreateRoomMutex.Lock()
	defer fake.validateCreateRoomMutex.Unlock()
	fake.ValidateCreateRoomStub = stub
}

func (fake *FakeRoomAllocator) ValidateCreateRoomArgsForCall(i int) (context.Context, hublive.RoomName) {
	fake.validateCreateRoomMutex.RLock()
	defer fake.validateCreateRoomMutex.RUnlock()
