...
func (fake *FakeServiceStore) ListParticipants(arg1 context.Context, arg2 hublive.RoomName) ([]*hublive.ParticipantInfo, error) {
...
func (fake *FakeServiceStore) ListParticipantsCalls(stub func(context.Context, hublive.RoomName) ([]*hublive.ParticipantInfo, error)) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
	fake.ListParticipantsStub = stub
}

func (fake *FakeServiceStore) ListParticipantsArgsForCall(i int) (context.Context, hublive.RoomName) {
	fake.listParticipantsMutex.RLock()
	defer fake.listParticipantsMutex.RUnlock()
...
func (fake *FakeServiceStore) ListParticipantsReturns(result1 []*hublive.ParticipantInfo, result2 error) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
...
func (fake *FakeServiceStore) ListParticipantsReturnsOnCall(i int, result1 []*hublive.ParticipantInfo, result2 error) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
	fake.ListParticipantsStub = nil
...
func (fake *FakeServiceStore) ListRooms(arg1 context.Context, arg2 []hublive.RoomName) ([]*hublive.Room, error) {
...
func (fake *FakeServiceStore) ListRoomsCalls(stub func(context.Context, []hublive.RoomName) ([]*hublive.Room, error)) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
	fake.ListRoomsStub = stub
}

func (fake *FakeServiceStore) ListRoomsArgsForCall(i int) (context.Context, []hublive.RoomName) {
	fake.listRoomsMutex.RLock()
	defer fake.listRoomsMutex.RUnlock()
...
func (fake *FakeServiceStore) ListRoomsReturns(result1 []*hublive.Room, result2 error) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
...
func (fake *FakeServiceStore) ListRoomsReturnsOnCall(i int, result1 []*hublive.Room, result2 error) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
	fake.ListRoomsStub = nil
...
func (fake *FakeServiceStore) LoadParticipant(arg1 context.Context, arg2 hublive.RoomName, arg3 hublive.ParticipantIdentity) (*hublive.ParticipantInfo, error) {
...
func (fake *FakeServiceStore) LoadParticipantCalls(stub func(context.Context, hublive.RoomName, hublive.ParticipantIdentity) (*hublive.ParticipantInfo, error)) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
	fake.LoadParticipantStub = stub
}

func (fake *FakeServiceStore) LoadParticipantArgsForCall(i int) (context.Context, hublive.RoomName, hublive.ParticipantIdentity) {
	fake.loadParticipantMutex.RLock()
	defer fake.loadParticipantMutex.RUnlock()
...
func (fake *FakeServiceStore) LoadParticipantReturns(result1 *hublive.ParticipantInfo, result2 error) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
...
func (fake *FakeServiceStore) LoadParticipantReturnsOnCall(i int, result1 *hublive.ParticipantInfo, result2 error) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
	fake.LoadParticipantStub = nil
...
func (fake *FakeServiceStore) LoadRoom(arg1 context.Context, arg2 hublive.RoomName, arg3 bool) (*hublive.Room, *hublive.RoomInternal, error) {
...
func (fake *FakeServiceStore) LoadRoomCalls(stub func(context.Context, hublive.RoomName, bool) (*hublive.Room, *hublive.RoomInternal, error)) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
	fake.LoadRoomStub = stub
}

func (fake *FakeServiceStore) LoadRoomArgsForCall(i int) (context.Context, hublive.RoomName, bool) {
	fake.loadRoomMutex.RLock()
	defer fake.loadRoomMutex.RUnlock()
...
func (fake *FakeServiceStore) LoadRoomReturns(result1 *hublive.Room, result2 *hublive.RoomInternal, result3 error) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
...
func (fake *FakeServiceStore) LoadRoomReturnsOnCall(i int, result1 *hublive.Room, result2 *hublive.RoomInternal, result3 error) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
	fake.LoadRoomStub = nil
...
func (fake *FakeServiceStore) RoomExists(arg1 context.Context, arg2 hublive.RoomName) (bool, error) {
...
func (fake *FakeServiceStore) RoomExistsCalls(stub func(context.Context, hublive.RoomName) (bool, error)) {
	fake.roomExistsMutex.Lock()
	defer fake.roomExistsMutex.Unlock()
	fake.RoomExistsStub = stub
}

func (fake *FakeServiceStore) RoomExistsArgsForCall(i int) (context.Context, hublive.RoomName) {
	fake.roomExistsMutex.RLock()
	defer fake.roomExistsMutex.RUnlock()
