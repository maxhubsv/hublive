...
func (c *roomManagerClient) CreateRoom(ctx context.Context, nodeID hublive.NodeID, req *hublive.CreateRoomRequest, opts ...psrpc.RequestOption) (*hublive.Room, error) {
