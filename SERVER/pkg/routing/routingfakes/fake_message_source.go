...
type FakeMessageSource struct {
	...
	ConnectionIDStub        func() hublive.ConnectionID
...
func (fake *FakeMessageSource) ConnectionID() hublive.ConnectionID {
...
func (fake *FakeMessageSource) ConnectionIDCalls(stub func() hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = stub
}

func (fake *FakeMessageSource) ConnectionIDReturns(result1 hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
...
func (fake *FakeMessageSource) ConnectionIDReturnsOnCall(i int, result1 hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = nil
