...
type FakeRoomManagerClient struct {
	...
	CreateRoomStub        func(context.Context, hublive.NodeID, *hublive.CreateRoomRequest, ...psrpc.RequestOption) (*hublive.Room, error)
	createRoomMutex       sync.RWMutex
	createRoomArgsForCall []struct {
		arg1 context.Context
		arg2 hublive.NodeID
		arg3 *hublive.CreateRoomRequest
...
func (fake *FakeRoomManagerClient) CreateRoom(arg1 context.Context, arg2 hublive.NodeID, arg3 *hublive.CreateRoomRequest, arg4 ...psrpc.RequestOption) (*hublive.Room, error) {
...
func (fake *FakeRoomManagerClient) CreateRoomCalls(stub func(context.Context, hublive.NodeID, *hublive.CreateRoomRequest, ...psrpc.RequestOption) (*hublive.Room, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRoomManagerClient) CreateRoomArgsForCall(i int) (context.Context, hublive.NodeID, *hublive.CreateRoomRequest, []psrpc.RequestOption) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturns(result1 *hublive.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturnsOnCall(i int, result1 *hublive.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
