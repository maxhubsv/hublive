...
func (fake *FakeMessageSink) ConnectionID() hublive.ConnectionID {
...
func (fake *FakeMessageSink) ConnectionIDCalls(stub func() hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = stub
}

func (fake *FakeMessageSink) ConnectionIDReturns(result1 hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
...
func (fake *FakeMessageSink) ConnectionIDReturnsOnCall(i int, result1 hublive.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = nil
