...
func NewDefaultMessageChannel(connectionID hublive.ConnectionID) *MessageChannel {
	return NewMessageChannel(connectionID, DefaultMessageChannelSize)
}

func NewMessageChannel(connectionID hublive.ConnectionID, size int) *MessageChannel {
...
func (m *MessageChannel) ConnectionID() hublive.ConnectionID {
