...
func (s *StaticClientConfigurationManager) GetConfiguration(clientInfo *hublive.ClientInfo) *hublive.ClientConfiguration {
	var matchedConf []*hublive.ClientConfiguration
	...
	var conf *hublive.ClientConfiguration
