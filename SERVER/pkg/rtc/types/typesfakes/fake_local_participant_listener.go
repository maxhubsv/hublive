...
type FakeLocalParticipantListener struct {
	OnDataMessageStub        func(types.LocalParticipant, hublive.DataPacket_Kind, *hublive.DataPacket)
	onDataMessageMutex       sync.RWMutex
	onDataMessageArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 hublive.DataPacket_Kind
		arg3 *hublive.DataPacket
	}
	...
	OnMetricsStub        func(types.Participant, *hublive.DataPacket)
	onMetricsMutex       sync.RWMutex
	onMetricsArgsForCall []struct {
		arg1 types.Participant
		arg2 *hublive.DataPacket
	}
	...
	OnSimulateScenarioStub        func(types.LocalParticipant, *hublive.SimulateScenario) error
	onSimulateScenarioMutex       sync.RWMutex
	onSimulateScenarioArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *hublive.SimulateScenario
	}
	...
	OnSubscribeStatusChangedStub        func(types.LocalParticipant, hublive.ParticipantID, bool)
	onSubscribeStatusChangedMutex       sync.RWMutex
	onSubscribeStatusChangedArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 hublive.ParticipantID
		arg3 bool
	}
	...
	OnSyncStateStub        func(types.LocalParticipant, *hublive.SyncState) error
	onSyncStateMutex       sync.RWMutex
	onSyncStateArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *hublive.SyncState
	}
	...
	OnUpdateDataSubscriptionsStub        func(types.LocalParticipant, *hublive.UpdateDataSubscription)
	onUpdateDataSubscriptionsMutex       sync.RWMutex
	onUpdateDataSubscriptionsArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *hublive.UpdateDataSubscription
	}
	OnUpdateSubscriptionPermissionStub        func(types.LocalParticipant, *hublive.SubscriptionPermission) error
	onUpdateSubscriptionPermissionMutex       sync.RWMutex
	onUpdateSubscriptionPermissionArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *hublive.SubscriptionPermission
	}
	...
	OnUpdateSubscriptionsStub        func(types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool)
	onUpdateSubscriptionsMutex       sync.RWMutex
	onUpdateSubscriptionsArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 []hublive.TrackID
		arg3 []*hublive.ParticipantTracks
		arg4 bool
	}
...
func (fake *FakeLocalParticipantListener) OnDataMessage(arg1 types.LocalParticipant, arg2 hublive.DataPacket_Kind, arg3 *hublive.DataPacket) {
...
func (fake *FakeLocalParticipantListener) OnDataMessageCalls(stub func(types.LocalParticipant, hublive.DataPacket_Kind, *hublive.DataPacket)) {
	fake.onDataMessageMutex.Lock()
	defer fake.onDataMessageMutex.Unlock()
	fake.OnDataMessageStub = stub
}

func (fake *FakeLocalParticipantListener) OnDataMessageArgsForCall(i int) (types.LocalParticipant, hublive.DataPacket_Kind, *hublive.DataPacket) {
	fake.onDataMessageMutex.RLock()
	defer fake.onDataMessageMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnMetrics(arg1 types.Participant, arg2 *hublive.DataPacket) {
...
func (fake *FakeLocalParticipantListener) OnMetricsCalls(stub func(types.Participant, *hublive.DataPacket)) {
	fake.onMetricsMutex.Lock()
	defer fake.onMetricsMutex.Unlock()
	fake.OnMetricsStub = stub
}

func (fake *FakeLocalParticipantListener) OnMetricsArgsForCall(i int) (types.Participant, *hublive.DataPacket) {
	fake.onMetricsMutex.RLock()
	defer fake.onMetricsMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSimulateScenario(arg1 types.LocalParticipant, arg2 *hublive.SimulateScenario) error {
...
func (fake *FakeLocalParticipantListener) OnSimulateScenarioCalls(stub func(types.LocalParticipant, *hublive.SimulateScenario) error) {
	fake.onSimulateScenarioMutex.Lock()
	defer fake.onSimulateScenarioMutex.Unlock()
	fake.OnSimulateScenarioStub = stub
}

func (fake *FakeLocalParticipantListener) OnSimulateScenarioArgsForCall(i int) (types.LocalParticipant, *hublive.SimulateScenario) {
	fake.onSimulateScenarioMutex.RLock()
	defer fake.onSimulateScenarioMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSubscribeStatusChanged(arg1 types.LocalParticipant, arg2 hublive.ParticipantID, arg3 bool) {
...
func (fake *FakeLocalParticipantListener) OnSubscribeStatusChangedCalls(stub func(types.LocalParticipant, hublive.ParticipantID, bool)) {
	fake.onSubscribeStatusChangedMutex.Lock()
	defer fake.onSubscribeStatusChangedMutex.Unlock()
	fake.OnSubscribeStatusChangedStub = stub
}

func (fake *FakeLocalParticipantListener) OnSubscribeStatusChangedArgsForCall(i int) (types.LocalParticipant, hublive.ParticipantID, bool) {
	fake.onSubscribeStatusChangedMutex.RLock()
	defer fake.onSubscribeStatusChangedMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSyncState(arg1 types.LocalParticipant, arg2 *hublive.SyncState) error {
...
func (fake *FakeLocalParticipantListener) OnSyncStateCalls(stub func(types.LocalParticipant, *hublive.SyncState) error) {
	fake.onSyncStateMutex.Lock()
	defer fake.onSyncStateMutex.Unlock()
	fake.OnSyncStateStub = stub
}

func (fake *FakeLocalParticipantListener) OnSyncStateArgsForCall(i int) (types.LocalParticipant, *hublive.SyncState) {
	fake.onSyncStateMutex.RLock()
	defer fake.onSyncStateMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptions(arg1 types.LocalParticipant, arg2 *hublive.UpdateDataSubscription) {
...
func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptionsCalls(stub func(types.LocalParticipant, *hublive.UpdateDataSubscription)) {
	fake.onUpdateDataSubscriptionsMutex.Lock()
	defer fake.onUpdateDataSubscriptionsMutex.Unlock()
	fake.OnUpdateDataSubscriptionsStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptionsArgsForCall(i int) (types.LocalParticipant, *hublive.UpdateDataSubscription) {
	fake.onUpdateDataSubscriptionsMutex.RLock()
	defer fake.onUpdateDataSubscriptionsMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermission(arg1 types.LocalParticipant, arg2 *hublive.SubscriptionPermission) error {
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermissionCalls(stub func(types.LocalParticipant, *hublive.SubscriptionPermission) error) {
	fake.onUpdateSubscriptionPermissionMutex.Lock()
	defer fake.onUpdateSubscriptionPermissionMutex.Unlock()
	fake.OnUpdateSubscriptionPermissionStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermissionArgsForCall(i int) (types.LocalParticipant, *hublive.SubscriptionPermission) {
	fake.onUpdateSubscriptionPermissionMutex.RLock()
	defer fake.onUpdateSubscriptionPermissionMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptions(arg1 types.LocalParticipant, arg2 []hublive.TrackID, arg3 []*hublive.ParticipantTracks, arg4 bool) {
	var arg2Copy []hublive.TrackID
	if arg2 != nil {
		arg2Copy = make([]hublive.TrackID, len(arg2))
		copy(arg2Copy, arg2)
	}
	var arg3Copy []*hublive.ParticipantTracks
	if arg3 != nil {
		arg3Copy = make([]*hublive.ParticipantTracks, len(arg3))
		copy(arg3Copy, arg3)
	}
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionsCalls(stub func(types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool)) {
	fake.onUpdateSubscriptionsMutex.Lock()
	defer fake.onUpdateSubscriptionsMutex.Unlock()
	fake.OnUpdateSubscriptionsStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionsArgsForCall(i int) (types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool) {
	fake.onUpdateSubscriptionsMutex.RLock()
	defer fake.onUpdateSubscriptionsMutex.RUnlock()
