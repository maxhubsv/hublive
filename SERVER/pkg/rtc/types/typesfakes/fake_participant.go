...
func (fake *FakeParticipant) GetPublishedTrack(arg1 hublive.TrackID) types.MediaTrack {
...
func (fake *FakeParticipant) GetPublishedTrackCalls(stub func(hublive.TrackID) types.MediaTrack) {
	fake.getPublishedTrackMutex.Lock()
	defer fake.getPublishedTrackMutex.Unlock()
	fake.GetPublishedTrackStub = stub
}

func (fake *FakeParticipant) GetPublishedTrackArgsForCall(i int) hublive.TrackID {
	fake.getPublishedTrackMutex.RLock()
	defer fake.getPublishedTrackMutex.RUnlock()
...
func (fake *FakeParticipant) HasPermission(arg1 hublive.TrackID, arg2 hublive.ParticipantIdentity) bool {
...
func (fake *FakeParticipant) HasPermissionCalls(stub func(hublive.TrackID, hublive.ParticipantIdentity) bool) {
	fake.hasPermissionMutex.Lock()
	defer fake.hasPermissionMutex.Unlock()
	fake.HasPermissionStub = stub
}

func (fake *FakeParticipant) HasPermissionArgsForCall(i int) (hublive.TrackID, hublive.ParticipantIdentity) {
	fake.hasPermissionMutex.RLock()
	defer fake.hasPermissionMutex.RUnlock()
...
func (fake *FakeParticipant) ID() hublive.ParticipantID {
	fake.iDMutex.Lock()
...
func (fake *FakeParticipant) IDCalls(stub func() hublive.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeParticipant) IDReturns(result1 hublive.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeParticipant) IDReturnsOnCall(i int, result1 hublive.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeParticipant) Identity() hublive.ParticipantIdentity {
...
func (fake *FakeParticipant) IdentityCalls(stub func() hublive.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
	fake.IdentityStub = stub
}

func (fake *FakeParticipant) IdentityReturns(result1 hublive.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
...
func (fake *FakeParticipant) IdentityReturnsOnCall(i int, result1 hublive.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
	fake.IdentityStub = nil
...
func (fake *FakeParticipant) Kind() hublive.ParticipantInfo_Kind {
	fake.kindMutex.Lock()
...
func (fake *FakeParticipant) KindCalls(stub func() hublive.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = stub
}

func (fake *FakeParticipant) KindReturns(result1 hublive.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = nil
...
func (fake *FakeParticipant) KindReturnsOnCall(i int, result1 hublive.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = nil
...
func (fake *FakeParticipant) State() hublive.ParticipantInfo_State {
...
func (fake *FakeParticipant) StateCalls(stub func() hublive.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = stub
}

func (fake *FakeParticipant) StateReturns(result1 hublive.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = nil
...
func (fake *FakeParticipant) StateReturnsOnCall(i int, result1 hublive.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = nil
...
func (fake *FakeParticipant) SubscriptionPermission() (*hublive.SubscriptionPermission, utils.TimedVersion) {
...
func (fake *FakeParticipant) SubscriptionPermissionCalls(stub func() (*hublive.SubscriptionPermission, utils.TimedVersion)) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
	fake.SubscriptionPermissionStub = stub
}

func (fake *FakeParticipant) SubscriptionPermissionReturns(result1 *hublive.SubscriptionPermission, result2 utils.TimedVersion) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
...
func (fake *FakeParticipant) SubscriptionPermissionReturnsOnCall(i int, result1 *hublive.SubscriptionPermission, result2 utils.TimedVersion) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
	fake.SubscriptionPermissionStub = nil
...
func (fake *FakeParticipant) ToProto() *hublive.ParticipantInfo {
...
func (fake *FakeParticipant) ToProtoCalls(stub func() *hublive.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = stub
}

func (fake *FakeParticipant) ToProtoReturns(result1 *hublive.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
...
func (fake *FakeParticipant) ToProtoReturnsOnCall(i int, result1 *hublive.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = nil
...
func (fake *FakeParticipant) ToProtoWithVersion() (*hublive.ParticipantInfo, utils.TimedVersion) {
...
func (fake *FakeParticipant) ToProtoWithVersionCalls(stub func() (*hublive.ParticipantInfo, utils.TimedVersion)) {
	fake.toProtoWithVersionMutex.Lock()
	defer fake.toProtoWithVersionMutex.Unlock()
	fake.ToProtoWithVersionStub = stub
}

func (fake *FakeParticipant) ToProtoWithVersionReturns(result1 *hublive.ParticipantInfo, result2 utils.TimedVersion) {
	fake.toProtoWithVersionMutex.Lock()
	defer fake.toProtoWithVersionMutex.Unlock()
...
func (fake *FakeParticipant) ToProtoWithVersionReturnsOnCall(i int, result1 *hublive.ParticipantInfo, result2 utils.TimedVersion) {
	fake.toProtoWithVersionMutex.Lock()
	defer fake.toProtoWithVersionMutex.Unlock()
	fake.ToProtoWithVersionStub = nil
...
func (fake *FakeParticipant) UpdateSubscriptionPermission(arg1 *hublive.SubscriptionPermission, arg2 utils.TimedVersion, arg3 func(participantID hublive.ParticipantID) types.LocalParticipant) error {
...
func (fake *FakeParticipant) UpdateSubscriptionPermissionCalls(stub func(*hublive.SubscriptionPermission, utils.TimedVersion, func(participantID hublive.ParticipantID) types.LocalParticipant) error) {
	fake.updateSubscriptionPermissionMutex.Lock()
	defer fake.updateSubscriptionPermissionMutex.Unlock()
	fake.UpdateSubscriptionPermissionStub = stub
}

func (fake *FakeParticipant) UpdateSubscriptionPermissionArgsForCall(i int) (*hublive.SubscriptionPermission, utils.TimedVersion, func(participantID hublive.ParticipantID) types.LocalParticipant) {
	fake.updateSubscriptionPermissionMutex.RLock()
	defer fake.updateSubscriptionPermissionMutex.RUnlock()
