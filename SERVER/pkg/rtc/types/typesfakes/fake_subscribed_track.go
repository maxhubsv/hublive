...
type FakeSubscribedTrack struct {
	...
	SubscriberIDStub        func() hublive.ParticipantID
	...
	SubscriberIdentityStub        func() hublive.ParticipantIdentity
	...
	UpdateSubscriberSettingsStub        func(*hublive.UpdateTrackSettings, bool)
	updateSubscriberSettingsMutex       sync.RWMutex
	updateSubscriberSettingsArgsForCall []struct {
		arg1 *hublive.UpdateTrackSettings
		arg2 bool
	}
...
func (fake *FakeSubscribedTrack) ID() hublive.TrackID {
	fake.iDMutex.Lock()
...
func (fake *FakeSubscribedTrack) IDCalls(stub func() hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeSubscribedTrack) IDReturns(result1 hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeSubscribedTrack) IDReturnsOnCall(i int, result1 hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeSubscribedTrack) PublisherID() hublive.ParticipantID {
...
func (fake *FakeSubscribedTrack) PublisherIDCalls(stub func() hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = stub
}

func (fake *FakeSubscribedTrack) PublisherIDReturns(result1 hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
...
func (fake *FakeSubscribedTrack) PublisherIDReturnsOnCall(i int, result1 hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = nil
...
func (fake *FakeSubscribedTrack) PublisherIdentity() hublive.ParticipantIdentity {
...
func (fake *FakeSubscribedTrack) PublisherIdentityCalls(stub func() hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = stub
}

func (fake *FakeSubscribedTrack) PublisherIdentityReturns(result1 hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
...
func (fake *FakeSubscribedTrack) PublisherIdentityReturnsOnCall(i int, result1 hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = nil
...
func (fake *FakeSubscribedTrack) SubscriberID() hublive.ParticipantID {
...
func (fake *FakeSubscribedTrack) SubscriberIDCalls(stub func() hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = stub
}

func (fake *FakeSubscribedTrack) SubscriberIDReturns(result1 hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
...
func (fake *FakeSubscribedTrack) SubscriberIDReturnsOnCall(i int, result1 hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = nil
...
func (fake *FakeSubscribedTrack) SubscriberIdentity() hublive.ParticipantIdentity {
...
func (fake *FakeSubscribedTrack) SubscriberIdentityCalls(stub func() hublive.ParticipantIdentity) {
	fake.subscriberIdentityMutex.Lock()
	defer fake.subscriberIdentityMutex.Unlock()
	fake.SubscriberIdentityStub = stub
}

func (fake *FakeSubscribedTrack) SubscriberIdentityReturns(result1 hublive.ParticipantIdentity) {
	fake.subscriberIdentityMutex.Lock()
	defer fake.subscriberIdentityMutex.Unlock()
...
func (fake *FakeSubscribedTrack) SubscriberIdentityReturnsOnCall(i int, result1 hublive.ParticipantIdentity) {
	fake.subscriberIdentityMutex.Lock()
	defer fake.subscriberIdentityMutex.Unlock()
	fake.SubscriberIdentityStub = nil
...
func (fake *FakeSubscribedTrack) UpdateSubscriberSettings(arg1 *hublive.UpdateTrackSettings, arg2 bool) {
...
func (fake *FakeSubscribedTrack) UpdateSubscriberSettingsCalls(stub func(*hublive.UpdateTrackSettings, bool)) {
	fake.updateSubscriberSettingsMutex.Lock()
	defer fake.updateSubscriberSettingsMutex.Unlock()
	fake.UpdateSubscriberSettingsStub = stub
}

func (fake *FakeSubscribedTrack) UpdateSubscriberSettingsArgsForCall(i int) (*hublive.UpdateTrackSettings, bool) {
	fake.updateSubscriberSettingsMutex.RLock()
	defer fake.updateSubscriberSettingsMutex.RUnlock()
