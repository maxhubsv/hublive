...
type FakeDataDownTrack struct {
	...
	UpdateSubscriptionOptionsStub        func(*hublive.DataTrackSubscriptionOptions)
	updateSubscriptionOptionsMutex       sync.RWMutex
	updateSubscriptionOptionsArgsForCall []struct {
		arg1 *hublive.DataTrackSubscriptionOptions
	}
...
func (fake *FakeDataDownTrack) UpdateSubscriptionOptions(arg1 *hublive.DataTrackSubscriptionOptions) {
...
func (fake *FakeDataDownTrack) UpdateSubscriptionOptionsCalls(stub func(*hublive.DataTrackSubscriptionOptions)) {
	fake.updateSubscriptionOptionsMutex.Lock()
	defer fake.updateSubscriptionOptionsMutex.Unlock()
	fake.UpdateSubscriptionOptionsStub = stub
}

func (fake *FakeDataDownTrack) UpdateSubscriptionOptionsArgsForCall(i int) *hublive.DataTrackSubscriptionOptions {
	fake.updateSubscriptionOptionsMutex.RLock()
	defer fake.updateSubscriptionOptionsMutex.RUnlock()
