...
func (fake *FakeParticipantListener) OnMetrics(arg1 types.Participant, arg2 *hublive.DataPacket) {
...
func (fake *FakeParticipantListener) OnMetricsCalls(stub func(types.Participant, *hublive.DataPacket)) {
	fake.onMetricsMutex.Lock()
	defer fake.onMetricsMutex.Unlock()
	fake.OnMetricsStub = stub
}

func (fake *FakeParticipantListener) OnMetricsArgsForCall(i int) (types.Participant, *hublive.DataPacket) {
	fake.onMetricsMutex.RLock()
	defer fake.onMetricsMutex.RUnlock()
