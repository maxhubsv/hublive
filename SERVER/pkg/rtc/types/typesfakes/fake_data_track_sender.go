...
func (fake *FakeDataTrackSender) SubscriberID() hublive.ParticipantID {
...
func (fake *FakeDataTrackSender) SubscriberIDCalls(stub func() hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = stub
}

func (fake *FakeDataTrackSender) SubscriberIDReturns(result1 hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
...
func (fake *FakeDataTrackSender) SubscriberIDReturnsOnCall(i int, result1 hublive.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = nil
