...
type FakeRoom struct {
	...
	IDStub        func() hublive.RoomID
	iDMutex       sync.RWMutex
	iDArgsForCall []struct {
	}
	iDReturns struct {
		result1 hublive.RoomID
	}
	iDReturnsOnCall map[int]struct {
		result1 hublive.RoomID
	}
	IsDataMessageUserPacketDuplicateStub        func(*hublive.UserPacket) bool
	isDataMessageUserPacketDuplicateMutex       sync.RWMutex
	isDataMessageUserPacketDuplicateArgsForCall []struct {
		arg1 *hublive.UserPacket
	}
	...
	NameStub        func() hublive.RoomName
	nameMutex       sync.RWMutex
	nameArgsForCall []struct {
	}
	nameReturns struct {
		result1 hublive.RoomName
	}
	nameReturnsOnCall map[int]struct {
		result1 hublive.RoomName
	}
	RemoveParticipantStub        func(hublive.ParticipantIdentity, hublive.ParticipantID, types.ParticipantCloseReason)
	...
	ResolveDataTrackForSubscriberStub        func(types.LocalParticipant, hublive.TrackID) types.DataResolverResult
	...
	ResolveMediaTrackForSubscriberStub        func(types.LocalParticipant, hublive.TrackID) types.MediaResolverResult
	...
	UpdateSubscriptionsStub        func(types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool)
...
func (fake *FakeRoom) ID() hublive.RoomID {
	fake.iDMutex.Lock()
...
func (fake *FakeRoom) IDCalls(stub func() hublive.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeRoom) IDReturns(result1 hublive.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeRoom) IDReturnsOnCall(i int, result1 hublive.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeRoom) IsDataMessageUserPacketDuplicate(arg1 *hublive.UserPacket) bool {
...
func (fake *FakeRoom) IsDataMessageUserPacketDuplicateCalls(stub func(*hublive.UserPacket) bool) {
	fake.isDataMessageUserPacketDuplicateMutex.Lock()
	defer fake.isDataMessageUserPacketDuplicateMutex.Unlock()
	fake.IsDataMessageUserPacketDuplicateStub = stub
}

func (fake *FakeRoom) IsDataMessageUserPacketDuplicateArgsForCall(i int) *hublive.UserPacket {
	fake.isDataMessageUserPacketDuplicateMutex.RLock()
	defer fake.isDataMessageUserPacketDuplicateMutex.RUnlock()
...
func (fake *FakeRoom) Name() hublive.RoomName {
	fake.nameMutex.Lock()
...
func (fake *FakeRoom) NameCalls(stub func() hublive.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = stub
}

func (fake *FakeRoom) NameReturns(result1 hublive.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = nil
...
func (fake *FakeRoom) NameReturnsOnCall(i int, result1 hublive.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = nil
...
func (fake *FakeRoom) RemoveParticipant(arg1 hublive.ParticipantIdentity, arg2 hublive.ParticipantID, arg3 types.ParticipantCloseReason) {
...
func (fake *FakeRoom) RemoveParticipantCalls(stub func(hublive.ParticipantIdentity, hublive.ParticipantID, types.ParticipantCloseReason)) {
	fake.removeParticipantMutex.Lock()
	defer fake.removeParticipantMutex.Unlock()
	fake.RemoveParticipantStub = stub
}

func (fake *FakeRoom) RemoveParticipantArgsForCall(i int) (hublive.ParticipantIdentity, hublive.ParticipantID, types.ParticipantCloseReason) {
	fake.removeParticipantMutex.RLock()
	defer fake.removeParticipantMutex.RUnlock()
...
func (fake *FakeRoom) ResolveDataTrackForSubscriber(arg1 types.LocalParticipant, arg2 hublive.TrackID) types.DataResolverResult {
...
func (fake *FakeRoom) ResolveDataTrackForSubscriberCalls(stub func(types.LocalParticipant, hublive.TrackID) types.DataResolverResult) {
	fake.resolveDataTrackForSubscriberMutex.Lock()
	defer fake.resolveDataTrackForSubscriberMutex.Unlock()
	fake.ResolveDataTrackForSubscriberStub = stub
}

func (fake *FakeRoom) ResolveDataTrackForSubscriberArgsForCall(i int) (types.LocalParticipant, hublive.TrackID) {
	fake.resolveDataTrackForSubscriberMutex.RLock()
	defer fake.resolveDataTrackForSubscriberMutex.RUnlock()
...
func (fake *FakeRoom) ResolveMediaTrackForSubscriber(arg1 types.LocalParticipant, arg2 hublive.TrackID) types.MediaResolverResult {
...
func (fake *FakeRoom) ResolveMediaTrackForSubscriberCalls(stub func(types.LocalParticipant, hublive.TrackID) types.MediaResolverResult) {
	fake.resolveMediaTrackForSubscriberMutex.Lock()
	defer fake.resolveMediaTrackForSubscriberMutex.Unlock()
	fake.ResolveMediaTrackForSubscriberStub = stub
}

func (fake *FakeRoom) ResolveMediaTrackForSubscriberArgsForCall(i int) (types.LocalParticipant, hublive.TrackID) {
	fake.resolveMediaTrackForSubscriberMutex.RLock()
	defer fake.resolveMediaTrackForSubscriberMutex.RUnlock()
...
func (fake *FakeRoom) UpdateSubscriptions(arg1 types.LocalParticipant, arg2 []hublive.TrackID, arg3 []*hublive.ParticipantTracks, arg4 bool) {
...
func (fake *FakeRoom) UpdateSubscriptionsCalls(stub func(types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool)) {
	fake.updateSubscriptionsMutex.Lock()
	defer fake.updateSubscriptionsMutex.Unlock()
	fake.UpdateSubscriptionsStub = stub
}

func (fake *FakeRoom) UpdateSubscriptionsArgsForCall(i int) (types.LocalParticipant, []hublive.TrackID, []*hublive.ParticipantTracks, bool) {
	fake.updateSubscriptionsMutex.RLock()
	defer fake.updateSubscriptionsMutex.RUnlock()
