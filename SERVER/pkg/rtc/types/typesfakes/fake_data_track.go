...
type FakeDataTrack struct {
	...
	DeleteDataDownTrackStub        func(hublive.ParticipantID)
	...
	RemoveSubscriberStub        func(hublive.ParticipantID)
	removeSubscriberMutex       sync.RWMutex
	removeSubscriberArgsForCall []struct {
		arg1 hublive.ParticipantID
	}
	ToProtoStub        func() *hublive.DataTrackInfo
	toProtoMutex       sync.RWMutex
	toProtoArgsForCall []struct {
	}
	toProtoReturns struct {
		result1 *hublive.DataTrackInfo
	}
...
func (fake *FakeDataTrack) DeleteDataDownTrack(arg1 hublive.ParticipantID) {
...
func (fake *FakeDataTrack) DeleteDataDownTrackCalls(stub func(hublive.ParticipantID)) {
	fake.deleteDataDownTrackMutex.Lock()
	defer fake.deleteDataDownTrackMutex.Unlock()
	fake.DeleteDataDownTrackStub = stub
}

func (fake *FakeDataTrack) DeleteDataDownTrackArgsForCall(i int) hublive.ParticipantID {
	fake.deleteDataDownTrackMutex.RLock()
	defer fake.deleteDataDownTrackMutex.RUnlock()
...
func (fake *FakeDataTrack) ID() hublive.TrackID {
	fake.iDMutex.Lock()
...
func (fake *FakeDataTrack) IDCalls(stub func() hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeDataTrack) IDReturns(result1 hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeDataTrack) IDReturnsOnCall(i int, result1 hublive.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeDataTrack) IsSubscriber(arg1 hublive.ParticipantID) bool {
...
func (fake *FakeDataTrack) IsSubscriberCalls(stub func(hublive.ParticipantID) bool) {
	fake.isSubscriberMutex.Lock()
	defer fake.isSubscriberMutex.Unlock()
	fake.IsSubscriberStub = stub
}

func (fake *FakeDataTrack) IsSubscriberArgsForCall(i int) hublive.ParticipantID {
	fake.isSubscriberMutex.RLock()
	defer fake.isSubscriberMutex.RUnlock()
...
func (fake *FakeDataTrack) PublisherID() hublive.ParticipantID {
...
func (fake *FakeDataTrack) PublisherIDCalls(stub func() hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = stub
}

func (fake *FakeDataTrack) PublisherIDReturns(result1 hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
...
func (fake *FakeDataTrack) PublisherIDReturnsOnCall(i int, result1 hublive.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = nil
...
func (fake *FakeDataTrack) PublisherIdentity() hublive.ParticipantIdentity {
...
func (fake *FakeDataTrack) PublisherIdentityCalls(stub func() hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = stub
}

func (fake *FakeDataTrack) PublisherIdentityReturns(result1 hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
...
func (fake *FakeDataTrack) PublisherIdentityReturnsOnCall(i int, result1 hublive.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = nil
...
func (fake *FakeDataTrack) RemoveSubscriber(arg1 hublive.ParticipantID) {
...
func (fake *FakeDataTrack) RemoveSubscriberCalls(stub func(hublive.ParticipantID)) {
	fake.removeSubscriberMutex.Lock()
	defer fake.removeSubscriberMutex.Unlock()
	fake.RemoveSubscriberStub = stub
}

func (fake *FakeDataTrack) RemoveSubscriberArgsForCall(i int) hublive.ParticipantID {
	fake.removeSubscriberMutex.RLock()
	defer fake.removeSubscriberMutex.RUnlock()
...
func (fake *FakeDataTrack) ToProto() *hublive.DataTrackInfo {
...
func (fake *FakeDataTrack) ToProtoCalls(stub func() *hublive.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = stub
}

func (fake *FakeDataTrack) ToProtoReturns(result1 *hublive.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
...
func (fake *FakeDataTrack) ToProtoReturnsOnCall(i int, result1 *hublive.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = nil
