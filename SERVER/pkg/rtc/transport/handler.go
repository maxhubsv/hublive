...
type Handler interface {
	OnICECandidate(c *webrtc.ICECandidate, target hublive.SignalTarget) error
	OnInitialConnected()
	OnFullyEstablished()
	...
	OnDataMessage(kind hublive.DataPacket_Kind, data []byte)
...
func (h UnimplementedHandler) OnICECandidate(c *webrtc.ICECandidate, target hublive.SignalTarget) error {
...
func (h UnimplementedHandler) OnDataMessage(kind hublive.DataPacket_Kind, data []byte)            {}
