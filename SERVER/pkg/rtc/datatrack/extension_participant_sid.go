...
func NewExtensionParticipantSid(participantID hublive.ParticipantID) (*ExtensionParticipantSid, error) {
...
func (e *ExtensionParticipantSid) ParticipantID() hublive.ParticipantID {
...
func (e *ExtensionParticipantSid) Marshal() (Extension, error) {
	...
	return Extension{
		id:   uint8(hublive.DataTrackExtensionID_DTEI_PARTICIPANT_SID),
		data: data,
	}, nil
}

func (e *ExtensionParticipantSid) Unmarshal(ext Extension) error {
	if ext.id != uint8(hublive.DataTrackExtensionID_DTEI_PARTICIPANT_SID) {
	...
	e.participantID = hublive.ParticipantID(ext.data)
	return nil
}
