...
func registerCodecs(me *webrtc.MediaEngine, codecs []*hublive.Codec, rtcpFeedback RTCPFeedbackConfig, filterOutH264HighProfile bool) error {
	// audio codecs
...
func createMediaEngine(codecs []*hublive.Codec, config DirectionConfig, filterOutH264HighProfile bool) (*webrtc.MediaEngine, error) {
...
func IsCodecEnabled(codecs []*hublive.Codec, cap webrtc.RTPCodecCapability) bool {
...
func selectAlternativeVideoCodec(enabledCodecs []*hublive.Codec) string {
...
func selectAlternativeAudioCodec(enabledCodecs []*hublive.Codec) string {
	for _, c := range enabledCodecs {
