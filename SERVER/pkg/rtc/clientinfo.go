...
func (c ClientInfo) isGo() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk == hublive.ClientInfo_GO
}
...
func (c ClientInfo) SupportsCodecChange() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk != hublive.ClientInfo_GO && c.ClientInfo.Sdk != hublive.ClientInfo_UNKNOWN
}

func (c ClientInfo) CanHandleReconnectResponse() bool {
	if c.Sdk == hublive.ClientInfo_JS {
...
func (c ClientInfo) SupportsICETCP() bool {
	...
	if c.ClientInfo.Sdk == hublive.ClientInfo_GO {
		// Go does not support active TCP
		return false
	}
	if c.ClientInfo.Sdk == hublive.ClientInfo_SWIFT {
...
func (c ClientInfo) SupportsTrackSubscribedEvent() bool {
	return !(c.ClientInfo.GetSdk() == hublive.ClientInfo_RUST && c.ClientInfo.GetProtocol() < 10)
}
...
func (c ClientInfo) SupportsSctpZeroChecksum() bool {
	return !(c.ClientInfo.GetSdk() == hublive.ClientInfo_UNKNOWN ||
