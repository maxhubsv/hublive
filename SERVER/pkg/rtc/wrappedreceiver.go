...
func (r *WrappedReceiver) TrackID() hublive.TrackID {
...
func (r *WrappedReceiver) DeleteDownTrack(participantID hublive.ParticipantID) {
	r.lock.Lock()
...
type DummyReceiver struct {
	...
	downTracks         map[hublive.ParticipantID]sfu.TrackSender
	onReadyCallbacks   []func()
...
func NewDummyReceiver(trackID hublive.TrackID, streamId string, codec webrtc.RTPCodecParameters, headerExtensions []webrtc.RTPHeaderExtensionParameter) *DummyReceiver {
	return &DummyReceiver{
		trackID:          trackID,
		streamId:         streamId,
		codec:            codec,
		headerExtensions: headerExtensions,
		downTracks:       make(map[hublive.ParticipantID]sfu.TrackSender),
	}
}
...
func (d *DummyReceiver) Upgrade(receiver sfu.TrackReceiver) {
	...
	d.downTracks = make(map[hublive.ParticipantID]sfu.TrackSender)
...
func (d *DummyReceiver) TrackID() hublive.TrackID {
	return d.trackID
}
...
func (d *DummyReceiver) VideoLayerMode() hublive.VideoLayer_Mode {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) DeleteDownTrack(subscriberID hublive.ParticipantID) {
	d.downTrackLock.Lock()
	defer d.downTrackLock.Unlock()
...
func (d *DummyReceiver) TrackInfo() *hublive.TrackInfo {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) UpdateTrackInfo(ti *hublive.TrackInfo) {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) GetTrackStats() *hublive.RTPStats {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyRedReceiver) DeleteDownTrack(subscriberID hublive.ParticipantID) {
	d.downTrackLock.Lock()
	defer d.downTrackLock.Unlock()
