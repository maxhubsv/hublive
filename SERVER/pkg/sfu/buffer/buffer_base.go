...
import (
	...
	"__GITHUB_HUBLIVE__mediatransportutil/pkg/nack"
...
type BufferProvider interface {
	...
	SetSenderReportData(srData *hublive.RTCPSenderReportState)
	GetSenderReportData() *hublive.RTCPSenderReportState
	...
	CloseWithReason(reason string) (*hublive.RTPStats, error)
}
...
func (b *BufferBase) CloseWithReason(reason string) (stats *hublive.RTPStats, err error) {
	b.closeOnce.Do(func() {
...
func (b *BufferBase) stopRTPStats(reason string) (stats *hublive.RTPStats, statsLite *hublive.RTPStats) {
	if b.rtpStats != nil {
		b.rtpStats.Stop()
...
func (b *BufferBase) stopRTPStatsLite(reason string) (statsLite *hublive.RTPStats) {
	if b.rtpStatsLite != nil {
		b.rtpStatsLite.Stop()
...
func (b *BufferBase) SetSenderReportData(srData *hublive.RTCPSenderReportState) {
	b.RLock()
	didSet := false
	if b.rtpStats != nil {
...
func (b *BufferBase) GetSenderReportData() *hublive.RTCPSenderReportState {
	b.RLock()
	defer b.RUnlock()
...
func (b *BufferBase) GetStats() *hublive.RTPStats {
	b.RLock()
	defer b.RUnlock()
