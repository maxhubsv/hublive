...
func IsSimulcastMode(m hublive.VideoLayer_Mode) bool {
	return m == hublive.VideoLayer_ONE_SPATIAL_LAYER_PER_STREAM || m == hublive.VideoLayer_ONE_SPATIAL_LAYER_PER_STREAM_INCOMPLETE_RTCP_SR
}
