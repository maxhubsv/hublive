...
func NewStreamTrackerManager(
	...
	if trackInfo.Type == hublive.TrackType_VIDEO {
...
func (s *StreamTrackerManager) UpdateTrackInfo(ti *hublive.TrackInfo) {
...
func (s *StreamTrackerManager) getLayeredBitrateLocked() ([]int32, Bitrates) {
	...
	if s.videoLayerMode == hublive.VideoLayer_MULTIPLE_SPATIAL_LAYERS_PER_STREAM && s.ddTracker == nil {
