...
import (
	...
	"__GITHUB_HUBLIVE__protocol/utils/rtputil"
)
...
func RTCPSenderReportPropagationDelay(rsrs *hublive.RTCPSenderReportState, passThrough bool) time.Duration {
	if passThrough {
		return 0
	}
...
type rtpStatsBase struct {
	*rtpStatsBaseLite
	...
	srFirst  *hublive.RTCPSenderReportState
	srNewest *hublive.RTCPSenderReportState
...
func (r *rtpStatsBase) maybeAdjustFirstPacketTime(
	srData *hublive.RTCPSenderReportState,
	tsOffset uint64,
	extStartTS uint64,
...
func (r *rtpStatsBase) firstPacketTimeAdjustLogFields(now, firstTime int64, adjustment int64, extNowTS, extStartTS uint64, srData *hublive.RTCPSenderReportState, tsOffset uint64, timeSinceReceive, timeSinceFirst, samplesDuration time.Duration, samplesDiff int64) []any {
	return []any{
...
func (r *rtpStatsBase) getDrift(extStartTS, extHighestTS uint64) (
	packetDrift *hublive.RTPDrift,
	ntpReportDrift *hublive.RTPDrift,
	receivedReportDrift *hublive.RTPDrift,
	rebasedReportDrift *hublive.RTPDrift,
) {
	if r.firstTime != 0 {
...
func AggregateRTPStats(statsList []*hublive.RTPStats) *hublive.RTPStats {
...
func ReconcileRTPStatsWithRTX(primaryStats *hublive.RTPStats, rtxStats *hublive.RTPStats) *hublive.RTPStats {
