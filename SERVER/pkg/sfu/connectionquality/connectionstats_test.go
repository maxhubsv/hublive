...
func TestConnectionQuality(t *testing.T) {
	...
	t.Run("quality scorer operation", func(t *testing.T) {
		...
		require.Equal(t, hublive.ConnectionQuality_EXCELLENT, quality)
		...
		require.Equal(t, hublive.ConnectionQuality_POOR, quality)
		...
		require.Equal(t, hublive.ConnectionQuality_GOOD, quality)
		...
		require.Equal(t, hublive.ConnectionQuality_LOST, quality)
	...
	t.Run("codecs - packet", func(t *testing.T) {
		type expectedQuality struct {
			...
			expectedMOS          float32
			expectedQuality      hublive.ConnectionQuality
		}
		testCases := []struct {
			name              string
				...
				expectedQualities: []expectedQuality{
					{
						...
						expectedMOS:          4.6,
						expectedQuality:      hublive.ConnectionQuality_EXCELLENT,
					},
					{
						packetLossPercentage: 4.0,
						expectedMOS:          4.1,
						expectedQuality:      hublive.ConnectionQuality_GOOD,
					},
					{
						packetLossPercentage: 9.2,
						expectedMOS:          2.1,
						expectedQuality:      hublive.ConnectionQuality_POOR,
					},
				},
			},
