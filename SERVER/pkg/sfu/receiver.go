...
type WebRTCReceiver struct {
	*ReceiverBase
	...
	onStatsUpdate   func(w *WebRTCReceiver, stat *hublive.AnalyticsStat)
}
...
func NewWebRTCReceiver(
	...
	w.connectionStats.OnStatsUpdate(func(_cs *connectionquality.ConnectionStats, stat *hublive.AnalyticsStat) {
...
func (w *WebRTCReceiver) OnStatsUpdate(fn func(w *WebRTCReceiver, stat *hublive.AnalyticsStat)) {
	w.onStatsUpdate = fn
}

func (w *WebRTCReceiver) GetConnectionScoreAndQuality() (float32, hublive.ConnectionQuality) {
...
func (w *WebRTCReceiver) AddUpTrack(track TrackRemote, buff *buffer.Buffer) error {
	...
	layer := int32(0)
	if w.Kind() == webrtc.RTPCodecTypeVideo && w.videoLayerMode != hublive.VideoLayer_MULTIPLE_SPATIAL_LAYERS_PER_STREAM {
...
func (w *WebRTCReceiver) notifyMaxExpectedLayer(layer int32) {
	...
	if w.Kind() == webrtc.RTPCodecTypeAudio || ti.Source == hublive.TrackSource_SCREEN_SHARE {
