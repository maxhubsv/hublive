...
import (
	...
	"__GITHUB_HUBLIVE__protocol/utils/hwstats"
	"__GITHUB_HUBLIVE__protocol/webhook"
)

const (
	hubliveNamespace string = "hublive"
)
...
func Init(nodeID string, nodeType hublive.NodeType) error {
...
func GetNodeStats(nodeStartedAt int64, prevStats []*hublive.NodeStats, rateIntervals []time.Duration) (*hublive.NodeStats, error) {
...
func getNodeStatsRate(statsHistory []*hublive.NodeStats) *hublive.NodeStatsRate {
